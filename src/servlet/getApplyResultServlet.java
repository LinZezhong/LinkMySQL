...
public class getApplyResultServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public getApplyResultServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String sql="select * from User_Apply_Depart_View where User_Id='"+User_Id+"' and Org_Department_Id="+Org_Department_Id;
		...
		try{
			try{
				...
				if(rs.next()){
					...
					json.put("result", rs.getString("result"));
