...
//		Map<String, Object> map = new HashMap<String, Object>();
		try{
			if(rs.next() && rs.getString("User_Pwd").equals(User_Pwd)){
				try{
				jsonObj.put("loginPer","µ«¬º≥…π¶");
			...
			System.out.println("ª∂”≠ƒ˙£∫"+request.getParameter("User_Id"));
		}
		catch(Exception e){
			e.printStackTrace();
		}
