...
public class submitResultServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		linkMySQL.Link();
		String sql="update Org_Apply set Result='"+result+"',Message='"+message+"',State='“—…Û∫À' where User_Id='"+User_Id+"' AND Org_Department_Id="+Org_Department_Id;
		Boolean answer=linkMySQL.updateOrgApply(sql);
		JSONObject jsonObj=new JSONObject();
		try{
			if(answer){
				try{
					jsonObj.put("message","…Û∫À≥…π¶");
